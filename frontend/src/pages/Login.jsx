    ...
    <AuthShell title="Welcome back" subtitle="Sign in to continue trading gadgets safely.">
      <form onSubmit={submit} className="space-y-4" data-testid="login-form">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button data-testid="google-login" type="button" variant="outline" className="h-12 rounded-xl">
          ...
          <Button data-testid="apple-login" type="button" variant="outline" className="h-12 rounded-xl"><Apple className="mr-2 h-4 w-4" />Apple</Button>
        </div>
